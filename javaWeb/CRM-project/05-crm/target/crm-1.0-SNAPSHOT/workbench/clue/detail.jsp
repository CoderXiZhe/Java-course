	...
	$(function(){
		...
		$("#aname").keydown(function(event){
			...
			if(event.keyCode==13){
				...
				$.ajax({
					url:"workbench/clue/getActivityListAndNotByClueId.do",
					data:{
						"name":$.trim($("#aname").val()),
						"id":"${c.id}"
					},
		...
		$("#bundBtn").click(function () {
			...
			if($xz.length==0){
				...
				$.ajax({
					//workbench/clue/bund.do?cid=?&aid=?&
					url:"workbench/clue/bund.do",
					data:param,  //只用传param 之前写成"param":param 导致后台空指针
					type:"post",
					dataType:"json",
					success:function(data){
						/*
						...
						if(data.success){
							alert("关联成功")
							//清除搜索框中信息  复选框中✓去掉 清空activitySerachBody中数据
...
<%--						</tr>--%>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">																									<!--安全性问题  长度问题-->
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityBody"  class="table table-hover" style="width: 900px;">
