        ...
        <center>
            <form action="/myWeb/question/update">
                <table border="2">
                    <tr>
                        <td>编号:</td>
                        <td><input type="text" name="questionId" value="${requestScope.key.questionId}"
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="answer" value="A"
                             ${"A" eq key.answer?"checked":""}   >A
                            <input type="radio" name="answer" value="B"
                            ${"B" eq key.answer?"checked":""}   >B
                            <input type="radio" name="answer" value="C"
                            ${"C" eq key.answer?"checked":""}  >C
                            <input type="radio" name="answer" value="D"
                            ${"D" eq key.answer?"checked":""}  >D</td>
                    </tr>
                    <tr>
