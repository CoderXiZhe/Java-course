...
用户发起请求--Springwvc接收--Spring中的service对象--MyBatis处理数据
...
5.写springmvc , spring , mybatis的配置文件
    1) springmvc配置文件    【组件扫描器 视图解析器 注解驱动】
    2) spring配置文件       【dataSource sqlSessionFactoryBean MapperScannerConfigurer service 事务】
    3) mybatis主配置文件
    4）数据库的属性配置文件
