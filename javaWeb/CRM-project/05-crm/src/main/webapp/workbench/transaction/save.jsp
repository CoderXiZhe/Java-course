...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" class="form-horizontal"  method="post" role="form" style="position: relative; top: -30px;">
		<div class="form-group">
			...
			<label for="create-amountOfMoney" name="money" class="col-sm-2 control-label">金额</label>
			<div class="col-sm-10" style="width: 300px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time" name="expectedDate" id="create-expectedClosingDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="4eac97e0bd174043934ea1fe93c1e34e">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="f62f5a96e17f46f699f0e201056853ca">
			</div>
		</div>
